                        ...
                        <div class="x_content">
                            ...
                            <form action="{{ route('admin.product.add') }}" id="add-product" method="POST"
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <select name="category_id" id="product-category" required class="form-control">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <textarea id="product-description" name="description" rows="4" required
                                ...
                                <div class="item form-group">
                                    <div class="col-md-6 col-sm-6 offset-md-3">
                                        <button class="btn btn-primary btn_reset" type="reset">Làm mới</button>
