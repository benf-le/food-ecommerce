                                ...
                                <div class="profile_img">
                                    ...
                                    <form enctype="multipart/form-data">
                                        ...
                                        <a href="javascript:void(0)" class="btn btn-success update-avatar"
                                            ...
                                            <i class="fa fa-edit m-right-xs" style="margin-right: 3px"> Chọn ảnh</i>
                                        </a>
                                    </form>
                                </div>
                            ...
                            <div class="col-md-9 col-sm-9 ">
                                <form id="update-profile" data-parsley-validate class="form-horizontal form-label-left">
                                    ...
                                    <div class="item form-group">
                                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="name">Tên <span
                                                class="required">*</span>
                                        </label>
                                    ...
                                    <div class="item form-group">
                                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="email">Email (không thể thay đổi) <span
                                                class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 ">
                                    ...
                                    <div class="item form-group">
                                        <div class="col-md-6 col-sm-6 offset-md-3">
                                            <button class="btn btn-warning form-change-pass">Đổi
                                                mật khẩu</button>
                                ...
                                <form id="change-password" data-parsley-validate class="form-horizontal form-label-left"
                                    ...
                                    <div class="item form-group">
                                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="new-password">Mật
